...
export default async function DashboardPage() {
  ...
  const kpis = [
    ...
    { label: "Approved Quotes Ready to Convert", value: data.approvedQuotesReadyToConvert, icon: FileCheck2, tone: "bg-emerald-50 text-emerald-800", href: "/quotes?status=approved" },
