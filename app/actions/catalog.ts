...
const starterCatalog = [
  ["C9 Warm White Roofline Lights", "Roofline Lights", "per_foot", "ft", 12, 2.5, true, true, 1000, 0, 200], ["C9 Ridge Line Lights", "Roofline Lights", "per_foot", "ft", 12, 2.5, true, true, 500, 0, 100], ["Peak/Gable Lighting", "Roofline Lights", "each", "each", 75, 20, true, true, 50, 0, 10], ["C9 Multicolor Roofline Lights", "Roofline Lights", "per_foot", "ft", 9, 3, true, true, 800, 0, 150], ["Garland", "Garland", "per_foot", "ft", 18, 4, true, true, 300, 0, 50], ["36-inch Wreath", "Wreaths", "each", "each", 85, 45, true, true, 20, 0, 5], ["Walkway Stake Lights", "Walkway Lights", "per_foot", "ft", 10, 1.5, true, true, 600, 0, 100], ["Driveway Stake Lights", "Walkway Lights", "per_foot", "ft", 10, 1.5, true, true, 600, 0, 100], ["Tree Wrap", "Tree Lights", "per_tree", "tree", 150, 60, true, false, 0, 0, 0], ["Bush Lights", "Bush Lights", "per_bush", "bush", 75, 20, true, false, 0, 0, 0], ["Timer", "Timers", "each", "each", 25, 10, true, true, 25, 0, 5], ["Extension Cord", "Extension Cords", "each", "each", 15, 6, false, true, 40, 0, 10], ["Clips", "Clips/Stakes", "each", "each", 0, 0.1, false, true, 3000, 0, 500], ["Custom Labor", "Labor/Service", "hourly", "hour", 0, 0, true, false, 0, 0, 0], ["Storage Service", "Storage", "flat_fee", "service", 150, 0, true, false, 0, 0, 0], ["Takedown Service", "Takedown", "flat_fee", "service", 0, 0, true, false, 0, 0, 0],
] as const;
